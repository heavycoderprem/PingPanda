...
const Page = () => {
    ...
    return (
        <div className="flex w-full flex-1 items-center justify-center px-4 h-screen">
          <BackgroundPattern className="absolute inset-0 left-1/2 z-0 -translate-x-1/2 opacity-75" />
    
          <div className="relative z-10 flex justify-center flex-col items-center gap-6 text-center">
