  ...
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-gray text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
        ...
        <div className="w-8 h-[2px] discord-gray rounded-full my-2" />
        ...
        <div className="group mt-auto size-12 discord-gray rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-[#3ba55c] cursor-not-allowed">
